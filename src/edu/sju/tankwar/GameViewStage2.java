...
/**
 * Description: custom view of game main view for stage 2
 * 
 * @file GameView.java The team name Team F The principal author's name : Yuanhai Shi
 *       
 *  
 * @version 1.2
 * @author Yuanhai  Acknowledgment of help from other team members, by name: none
 */
public class GameViewStage2 extends View implements GameConstants {
	/** x,position of base */
	...
	/** record game win or lose status**/
	 ...
	 * @param context
	 */
	public GameViewStage2(Context context) {
		super(context);
	 ...
	 */
	public GameViewStage2(Context context, AttributeSet attrs) {
		// TODO Auto-generated constructor stub
		super(context, attrs);
	 ...
	 * when 10 enemy tanks are killed, show winning message
	 * @param s
	 *            shell
	 */
